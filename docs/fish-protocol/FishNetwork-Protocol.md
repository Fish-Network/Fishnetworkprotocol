...
Basic capital pooling infrastructure should be a right, not a privilege. We released Fish Protocol open source so anyone can pool capital for use cases outside of financial services, such as social activities or non-profits.
